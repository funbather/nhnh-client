...
define(function()
{
	...
	return {
		...
		ECLAGE_RECALL: 3035,
		SWD_SOUL: 4000,
		SWD_FORCEOFWILL: 4001,
		SWD_DAUNTLESS: 4002,
		SWD_HARDHEARTED: 4003,
		SWD_PAVISE: 4004,
		SWD_SWASHBUCKLING: 4005,
		SWD_SECONDWIND: 4006,
		SWD_SWAGGER: 4007,
		SWD_ENDURE: 4008,
		SWD_UMBOBLOW: 4009,
		SWD_METEORMASH: 4010,
		SWD_SHIELDBOOMERANG: 4011,
		SWD_SKULLCRACK: 4012,
		SWD_SLEDGEHAMMER: 4013,
		THF_SOUL: 4014,
		THF_DOUBLESTRIKE: 4015,
		THF_REFLEXES: 4016,
		THF_MERCILESS: 4017,
		THF_ADRENALINERUSH: 4018,
		THF_PICKPOCKET: 4019,
		THF_CAMOUFLAGE: 4020,
		THF_DOUBLETEAM: 4021,
		THF_BROWBEAT: 4022,
		THF_SONICSTRIKE: 4023,
		THF_BONECUTTER: 4024,
		THF_BLADEFLOURISH: 4025,
		THF_PUNCTURE: 4026,
		ACO_SOUL: 4027,
		ACO_LIFELINK: 4028,
		ACO_BENEVOLENCE: 4029,
		ACO_SPIRITWARD: 4030,
		ACO_PURIFY: 4031,
		ACO_CURE: 4032,
		ACO_RAISE: 4033,
		ACO_FORCEARMOR: 4034,
		ACO_GODSSTRENGTH: 4035,
		ACO_HALLOWEDBOLT: 4036,
		ACO_HEAVENLYBLOW: 4037,
		MGN_SOUL: 4038,
		MGN_FIRELANCE: 4039,
		MGN_INCINERATE: 4040,
		MGN_EXPLOSION: 4041,
		MGN_COMET: 4042,
		MGN_ICICLEEDGE: 4043,
		MGN_CRYSTALLIZE: 4044,
		MGN_ICENOVA: 4045,
		MGN_FROSTBITE: 4046,
		MGN_LIGHTNINGBOLT: 4047,
		MGN_IONPULSE: 4048,
		MGN_DISCHARGE: 4049,
		MGN_STORMLOCUS: 4050,

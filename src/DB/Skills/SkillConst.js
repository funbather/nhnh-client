...
define(function()
{
	...
	return {
		...
		SC_REJUVENATE: 4004,
		SC_INVIGORATE: 4005,
		SC_CALLSENTINEL: 4006,
		SC_ARCANECANNON: 4007,
		SC_SURGE:        4008,
		SC_PLASMAFIELD:  4009,
		SC_ARCANEVORTEX: 4010,
		SC_FLASHFREEZE:  4011,
		SC_ENERGIZE:     4012,
		SC_PHASEWALK:    4013,
		ALL_FIRSTAID:    4014,
		...
		ALL_ENDURANCE:   4022,
		ALL_CLARITY:     4023,
		ALL_FEATHERFOOT: 4024,
		WR_SHIELDBEARER: 4025,
		WR_DEFTDUELIST:  4026,
		WR_MONKEYGRIP:   4027,
		WR_TWINHAND:     4028,
		WR_HARDHEARTED:  4029,
		...
		WR_PILEBUNKER:   4033,
		WR_ECHOBLADE:    4034,
		WR_BULWARKBOOMERANG: 4035,
		WR_BULWARKBLITZ: 4036,
		WR_BULWARKBASH:  4037,
		ALL_PENGUIN:     4038,
		ALL_COMINRIGHTUP: 4039,
		TR_IMMUNITY:			4040,
		TR_LEYLINEWALKER: 4041,
		TR_STONESTANCE:		4042,
		TR_NATURALCURE:   4043,
		TR_POISONIMPRINT: 4044,
		TR_EARTHENSHIELD: 4045,
		TR_SLUDGEBOMB:		4046,
		TR_POISONBLOW:		4047,
		TR_TOXICDELUGE:		4048,
		TR_EXPUNGE:				4049,
		TR_TERRASPINE:		4050,
		TR_HEAVENSDRIVE:	4051,
		TR_GROUNDRIFT:		4052,
		TR_EARTHSHUDDER:	4053,
		TR_EXPUNGE_SPLASH: 4054,
		ALL_DOMINATE:     4055,
		ALL_REST:         4056,
		ALL_BOOSTER:      4057,
		ALL_MANABATTERY:  4058,
		ALL_BEGINCHARGE:  4059,
		ALL_DRAGONFAMILIAR: 4060,
		ALL_LODESTONEBURST: 4061,
		SWD_SOUL:					4062,
		SWD_HARDHEARTED:	4063,
		SWD_DAUNTLESS:		4064,
		SWD_MAINTENANCE:	4065,
		SWD_PAVISE:				4066,
		SWD_SWASHBUCKLING:4067,
		SWD_SECONDWIND:		4068,
		SWD_EYETOEYE:			4069,
		SWD_ENDURE:				4070,
		SWD_UMBOBLOW:			4071,
		SWD_SHIELDBOOMERANG: 4072,
		SWD_HILTBASH:			4073,
		SWD_HEAVYSWING:		4074,
		SWD_SLEDGEHAMMER:	4075,
		THF_SOUL:         4076,
		THF_QUICKHANDS:   4077,
		THF_REFLEXES:     4078,
		THF_MERCILESS:    4079,
		THF_ADRENALINERUSH:4080,
		THF_CAMOUFLAGE:   4081,
		THF_DOUBLETEAM:   4082,
		THF_SONICSTRIKE:  4083,
		THF_BONECUTTER:   4084,
		THF_BLADEFLOURISH:4085,
		THF_HAMSTRING:    4086,
		THF_STIFLE:       4087,
		THF_PUNCTURE:     4088,
	};

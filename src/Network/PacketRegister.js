...
*/
		...
		0x9fd: PACKET.ZC.NOTIFY_MOVEENTRY8,
		0x9ff: PACKET.ZC.NOTIFY_STANDENTRY8,
		0x9fe: PACKET.ZC.NOTIFY_NEWENTRY8,
		0xa09: PACKET.ZC.ADD_EXCHANGE_ITEM3,
		0xa0a: PACKET.ZC.ADD_ITEM_TO_STORE3,
		0xa0b: PACKET.ZC.ADD_ITEM_TO_CART3,
		0xa0c: PACKET.ZC.ITEM_PICKUP_ACK6,
		0xa0d: PACKET.ZC.EQUIPMENT_ITEMLIST4,
		0xa0f: PACKET.ZC.CART_EQUIPMENT_ITEMLIST4,
		0xa10: PACKET.ZC.STORE_EQUIPMENT_ITEMLIST4,
		0x9cb: PACKET.ZC.USE_SKILL2,
		0xa27: PACKET.ZC.RECOVERY2,
		0x8b3: PACKET.ZC.SHOWSCRIPT,
		0x985: PACKET.ZC.SKILL_POSTDELAY_LIST,
		
		0x9a8: PACKET.ZC.BANK_DEPOSIT_ACK,
		0x9aa: PACKET.ZC.BANK_WITHDRAW_ACK,

		0x555: PACKET.ZC.CLEAR_TEXT, // NHNH Custom Packet
		0x557: PACKET.ZC.BANK_AMOUNT,
		0x558: PACKET.ZC.CUBE_OPEN,
	};
});